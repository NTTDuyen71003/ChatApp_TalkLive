...
public class ServiceFIle {
    ...
    public void receiveFile(Model_package_image_sender dataPackage) throws IOException {
    ...
    public Model_send_message closeFile(Model_Receive_Image dataImage) throws IOException, SQLException {
        ...
        if (file.getMessage().getMessageType() == Message_type.IMAGE.getValue()) {
            //  Image file
    ...
    private String convertFileToBlurHash(File file, Model_Receive_Image dataImage) throws IOException {
        ...
        String blurhash = Blur_hash.encode(newImage);
    ...
    //  SQL
    private final String PATH_FILE = "server_img/";
