 ...
 * @author DD
 */
public class Model_image_sender {
    ...
    public Model_image_sender(File file, Socket socket, Model_send_message message) throws IOException {
    ...
    //event ảnh
    private EventImageSender event;

    public void addtEvent(EventImageSender event) {
        this.event = event;
    }
    ...
    private void sendingFile() throws IOException {
        Model_package_image_sender data = new Model_package_image_sender();
                    ...
                    if (act) {
                        try {
                            if (!data.isFinish()) {
                                ...
                                //  Gửi ảnh done
                                Service.getInstance().fileSendFinish(Model_image_sender.this);
                                if (event != null) {
                                    event.onFinish();
                                }
                            }
